...
# See https://docs.djangoproject.com/en/3.1/howto/deployment/checklist/   xxx
...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.c72mcm8uugbd.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-gul-blog' # please enter your s3 bucket name
